...
class POGEL::PHYSICS::SIMULATION : public POGEL::PHYSICS::DYNAMICS {
	...
	public:
		...
		bool processCONCAVESPHERE(POGEL::PHYSICS::SOLID*, POGEL::PHYSICS::SOLID*);
		bool processSPHEREGENERAL(POGEL::PHYSICS::SOLID*, POGEL::PHYSICS::SOLID*);
		bool processCONCAVESPHEREGENERAL(POGEL::PHYSICS::SOLID*, POGEL::PHYSICS::SOLID*);
