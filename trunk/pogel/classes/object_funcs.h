...
void addFunctionShape( POGEL::OBJECT* obj, SHAPE_FUNCTION_RESULT (*function)(SHAPE_FUNCTION_ARGS), const char* axesToLoop, POGEL::IMAGE* img, unsigned int triprop, float xSize = 1.0f, float ySize = 1.0f, float zSize = 1.0f, unsigned long xRes = 100, unsigned long yRes = 100, unsigned long zRes = 100);
